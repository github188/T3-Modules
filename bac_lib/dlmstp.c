...
/*static*/ uint8_t This_Station  = 0xff;
...
static uint8_t TransmitPacket[500];
...
#define Tframe_abort  7//3 // baud is 9600,Tframe_abort is 6, baud is 19200,Tframe_abort is 3, fixed by chelsea
    ...
    void)
{
	...
	//if(modbus.com_config[0] == MAIN_MSTP) port = 0;
	...
	switch (Receive_State) 
        ...
        case MSTP_RECEIVE_STATE_HEADER:	 
            ...
            if (Timer_Silence() > Tframe_abort) 
							{
									//#if (DEBUG_UART1)
									//	sprintf(debug_str,"HEADER timeout \r\n");
        ...
        case MSTP_RECEIVE_STATE_DATA: 	
            ...
            if (Timer_Silence() > Tframe_abort) {  
//#if (DEBUG_UART1)
//	sprintf(debug_str,"DATA timeout \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif	
                    ...
                    if (DataCRC == 0xF0B8) {
                        if ((DestinationAddress == This_Station) ||
                            ...
                            /* indicate that a frame with no data
                               has been received */
//#if (DEBUG_UART1)
//	sprintf(debug_str,"receive valid \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif	
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"receive invalid \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif	
    ...
    switch (Master_State) {
        case MSTP_MASTER_STATE_INITIALIZE:	
            ...
            transition_now = true;
						MSTP_Flag.ReceivedValidFrame = false;
						MSTP_Flag.ReceivedInvalidFrame = false;
						Timer_Silence_Reset();// GXY ADD  clear the timer
            break;
        ...
        case MSTP_MASTER_STATE_USE_TOKEN: 
            ...
            if (TransmitPacketLen) {  
			 	   // who is
//#if (DEBUG_UART1)
//	sprintf(debug_str,"TransmitPacketLen %u \r\n",(U16_T)TransmitPacketLen);
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif	
        ...
        case MSTP_MASTER_STATE_WAIT_FOR_REPLY:	
            ...
            if (Timer_Silence() >= Treply_timeout) {   
                ...
                if (MSTP_Flag.ReceivedInvalidFrame == true) { 
                    /* InvalidFrame */
//#if (DEBUG_UART1)
//	sprintf(debug_str,"WAIT_FOR_REPLY InvalidFrame \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif	
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"WAIT_FOR_REPLY validFrame \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
                    if (DestinationAddress == This_Station) {
                        /* What did we receive? */
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"WAIT_FOR_REPLY ReceivedUnexpectedFrame \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
...
//#endif	
                ...
                if (MSTP_Flag.SoleMaster == true) {	
//#if (DEBUG_UART1)
//	sprintf(debug_str,"SoleMasterRestartMaintenancePFM \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
                   //printf("PollMaster2"); 
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"ResetMaintenancePFM \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
										//printf("PassToken2");
                    /* ResetMaintenancePFM */
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"SendMaintenancePFM \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
								//printf("PollMaster3");
                /* SendMaintenancePFM */
        ...
        case MSTP_MASTER_STATE_PASS_TOKEN:	 
            if (Timer_Silence() <= Tusage_timeout) { 
	              if (EventCount > Nmin_octets) {  
                    /* SawTokenUser */
//#if (DEBUG_UART1)
//	sprintf(debug_str,"SawTokenUser \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"PASS_TOKEN timeout \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
                if (RetryCount < Nretry_token) { 
                    /* RetrySendToken */
//#if (DEBUG_UART1)
//	sprintf(debug_str,"PASS_TOKEN RetrySendToken \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
                    RetryCount++;
                    /* Transmit a Token frame to NS */
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"PASS_TOKEN FindNewSuccessor \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
                    /* FindNewSuccessor */
...
//#endif				
                ...
                if (Timer_Silence() < ns_timeout) {	 
                    /* GenerateToken */
//#if (DEBUG_UART1)
//	sprintf(debug_str,"NO_TOKEN GenerateToken %u\r\n",(U16_T)ns_timeout);
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif	
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"POLL_FOR_MASTER ReceivedValidFrame %u %u\r\n",
//	(U16_T)FrameType,
//	(U16_T)This_Station);
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"POLL_FOR_MASTER ReceivedUnexpectedFrame \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
                    /* ReceivedUnexpectedFrame */
                    /* An unexpected frame was received.  */
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"POLL_FOR_MASTER DoneWithPFM \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif	
                        /* DoneWithPFM */
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"POLL_FOR_MASTER SendNextPFM \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif									
                            /* SendNextPFM */	
                            Poll_Station = next_poll_station;
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"POLL_FOR_MASTER DeclareSoleMaster \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
                            /* DeclareSoleMaster */
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"DATA_REQUEST Reply \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif			
								//printf("TRSMIT");
...
//#if (DEBUG_UART1)
//	sprintf(debug_str,"DATA_REQUEST DeferredReply \r\n");
//	uart_send_string(debug_str,strlen(debug_str),UART_SUB1);
//#endif
                /* DeferredReply */
...
//		else if(port == 1)
//		{
//		 	memcpy(SendFrame[0].Buffer,pdu,pdu_len);
//	        SendFrame[0].Length = pdu_len;

//		}
//#endif
				//printf("mstpflag true ");
